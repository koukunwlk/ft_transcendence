<template>
  ...
  >
    <div class="h-[420px] w-72 md:h-[432px] lg:h-[452px] xl:h-[452px] md:w-96 xl:w-[412px] text-gray-300 rounded-lg border border-gray-500 flex flex-col justify-center items-center">
      <img
      ...
      <div class="flex flex-col items-center justify-center h-44 lg:h-48 w-64 md:w-80 xl:w-[352px] rounded-sm border border-gray-700">
