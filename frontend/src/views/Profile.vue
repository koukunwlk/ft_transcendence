...
<template>
	<div v-show="!this.isLoading" class="flex h-full md:h-6/6 justify-center">
					...
					<table class="min-w-full divide-y text-yellow-500">
						<tbody>
							<tr class="border-b-2 border-yellow-500">
								...
								<td class="px-6 py-4 whitespace-nowrap">{{ this.userStats.totalGames }}</td>
							</tr>
							<tr class="border-b-2 border-yellow-500">
								<th scope="row"
									class="bg-transparent px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
								...
								<td class="px-6 py-4 whitespace-nowrap">{{ this.userStats.wins }}</td>
							</tr>
							<tr class="border-b-2 border-yellow-500">
								<th scope="row"
									class="bg-transparent px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
								...
								<td class="px-6 py-4 whitespace-nowrap">{{ this.userStats.loses }}</td>
							</tr>
							<tr class="border-b-2 border-yellow-500">
								<th scope="row"
									class="bg-transparent px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
								...
								<td class="px-6 py-4 whitespace-nowrap">{{ this.userStats.winRate }}%</td>
							</tr>
							<tr>
								<th scope="row"
									class="bg-transparent px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
