            ...
            <div class="h-4/6 w-full flex flex-col justify-center ml-4 md:ml-6 xl:ml-8 2xl:ml-12">
                <div for="2f" class="flex flex-row justify-start mb-5">
                    <label class="inline-flex items-center cursor-pointer">
                        <input v-model="isChecked" @change="handleToggleChange" type="checkbox" id="2f" class="sr-only peer">
                ...
                <div class="pt-3">
                    ...
                    <div class="flex items-center">
                        <input placeholder="enter new nickname" required v-model="nickname" type="text" id="nickname" class="bg-gray-50 w-4/6 p-2.5 border border-gray-300 text-gray-900 text-sm rounded-sm focus:border-blue-500 block dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500"/>
                        <button type="button" @click="saveNickname" class="bg-yellow-500 text-sm text-gray-900 dark:text-gray-300 p-2.5 border-yellow-300 rounded-sm block dark:bg-yellow-500 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 ml-1">save</button>
                    </div>
                </div>
            </div>
        </div>
