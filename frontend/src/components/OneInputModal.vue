		  ...
		  <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
			<div class="sm:flex sm:items-start">
			  <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
				...
				<div class="mt-2 flex ">
				  <input type="text" class="mt-5 w-full rounded-md border-gray-200 border-2 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-md flex p-1" placeholder="..." v-model="inputValue">
				</div>
			  </div>
			</div>
		  </div>
