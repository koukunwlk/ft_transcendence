<template>
	<div class="grid grid-cols-2 md:grid-cols-4 gap-2">
		<!-- Add Friend Button -->
		<div class="">
			<button class="w-12 md:w-12 h-11 px-4 py-2 text-white shadow-lg shadow-yellow-500/5 rounded grid justify-center"
		...
		<div class=" ">
			...
			<listModal :title="'Friend Requests'" :isOpen="isFriendRequestModalOpen" :list="friendRequests"
				@close-modal="closeFriendRequestModal" />
		</div>
	</div>
</template>
